...
export default function SMR08({}: { courseId: string }) {
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-6 pt-14 pb-24 flex flex-col justify-between">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-6">
          <div>
            <p className="text-xs font-semibold text-blue-600 uppercase tracking-widest mb-1">Screen 8</p>
            <h1 className="text-3xl font-bold text-[#1c2434]">SMR08 — Boilerplate</h1>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
          <button
            onClick={() => router.push(`/course/social-media-ooo-recon/9`)}
