      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-6 pt-14 pb-24 flex flex-col gap-10">
        ...
        <div className="pt-4">
          <button
            ...
            className="w-full bg-[#145bb3] hover:bg-[#1c78e9] text-white font-bold py-5 rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3 active:scale-95"
          >
