...
export default function Screen07({ courseId }: { courseId: string }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-6 pt-14 pb-24 flex flex-col gap-6">
        <div>
          <p className="text-xs font-semibold text-[#8a99af] uppercase tracking-widest mb-1">Screen 7</p>
          <h1 className="text-3xl font-bold text-[#1c2434]">Placeholder</h1>
          <p className="text-[#64748b] mt-2">Content coming soon.</p>
        </div>
        <button
          onClick={() => router.push(`/course/${courseId}/8`)}
